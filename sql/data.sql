...
VALUES (1, 'Tomasz had too many tasks to do this week', 1, 1),
       (2, 'We have not completed two tasks', 1, 1),
       (3, 'Maybe we can assign another developer to this project', 1, 2),
       (4, 'We completed Task 1 which was very difficult', 1, 0),
       (5, 'Are we sure we need Task 4? It adds nothing to the project', 1, 3),
       (6, 'Maybe we can have 2-week sprints?', 2, 2),
       (7, 'Many new features have been implemented', 2, 0),
       (8, 'All tasks complete', 4, 0),
       (9, 'Good cooperation', 4, 0),
       (10, 'We can write cleaner code', 4, 1),
       (11, 'All team members should attend the daily', 4, 1),
       (12, 'Are we getting the requirements for the next service integration?', 4, 3),
       (13, 'The requirements are not well defined', 5, 1),
       (14, 'When do we start work on tasks 11 and 12?', 5, 3);
